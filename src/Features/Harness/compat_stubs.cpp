...
void *EVP_MAC_fetch(void *, const char *, const char *) {
	return nullptr;
}
void EVP_MAC_free(void *) {}
void *EVP_MAC_CTX_new(void *) {
	return nullptr;
}
...
int EVP_MAC_update(void *, const unsigned char *, unsigned long) {
	return 0;
}
int EVP_MAC_final(void *, unsigned char *, unsigned long *, unsigned long) {
	return 0;
}
int EVP_Q_digest(void *, const char *, const char *, const void *, unsigned long, unsigned char *, unsigned long *) {
	return 0;
}
int EVP_DigestSignUpdate(void *, const void *, unsigned long) {
	return 0;
}
...
int sd_is_socket_inet(int, int, int, int, unsigned short) {
	return 0;
}
int sd_is_socket_unix(int, int, int, const char *, unsigned int) {
	return 0;
}
