...
public:
	...
	const ClassLayout &GetClassLayout(uint16_t classId) const { return classLayouts[classId]; }
...
private:
	...
	void DiscoverSendTableFields(const std::string &className, struct SendTable *table);
