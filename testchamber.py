...
"""
Add following to launch options for steam

```
-vulkan -high -novid -sw -w 180 -h 180 -condebug +sv_cheats 1 +map rl_challenge_0 +plugin_load sar +sar_rla_server 1 +sar_tas_debug 1 +sar_tas_playback_rate 100 +hud_quickinfo 0 +sar_quickhud_mode 1 +sar_quickhud_size 4
```

If you still see the regular (big) portal indicators, type in `hud_quickinfo 0` on the developer console again.
"""
