...
public:
	...
	// TODO: mouse movement could be noisy since we reconstruct it from viewangles instead of directly reading it from CUserCmd
	void MapUserCmdToAction(const CUserCmd &cmd, portal2_harness::ActionRequest *req);
